...
% =========================================================================
% INPUT:
%   funObj : Objective function handle  (i.e. @your_function_name)
...
function [optm_x fv stats options] = eda_mcc(funObj, options, x, varargin)
